...
public class StatisticsService {
	...
	public StatisticsService(PatientRepository patientRepository, DoctorRepository doctorRepository,
			NurseRepository nurseRepository, AppointmentRepository appointmentRepository) {
	...
	public Integer getTotalStaffsCount() {
		return getTotalDoctorsCount() + (int) nurseRepository.count();
	}
