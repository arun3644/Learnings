...
public class AuthService {
	...
	public AuthService(AdminService adminService, JwtUtil jwtUtil, DoctorService doctorService, NurseService nurseService, PatientService patientService, PasswordEncoder passwordEncoder) {
	...
	public LoginResponse login(LoginRequest request) {
		...
		case "Nurse":
			...
			if(nurse != null && passwordMatches(password, nurse.getPassword())) {
		...
		case "Patient":
			...
			if(patient != null && passwordMatches(password, patient.getPassword())) {
