...
public class NurseController {
	...
	public ResponseEntity<?> getDepartments() {
		...
		response.put("department", new String[] {
			"ICU", "Emergency", "Surgery", "Pediatrics", 
			"Cardiology","Orthopedics", "General Ward", "Maternity"
		});
		return ResponseEntity.ok(response);
	}
	
	@GetMapping("/yearsOfExperience")
	public ResponseEntity<?> getYearsOfExperience() {
		Map<String, Object> response = new HashMap<>();
		response.put("yearsOfExperience", new Integer[] {
